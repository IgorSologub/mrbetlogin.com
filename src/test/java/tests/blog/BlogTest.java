...
public class BlogTest extends BaseTest {
    ...
    public void registerNowButtonClick () {
        basePage.closePopup();
        int goodTitlesCount = 0;
        for (int i = 1; i <= NUMBER_OF_REGISTER_NOW_BUTTON_BLOG_PAGE; i++) {
            basePage.waitOneSeconds();
            blogPage.registerNowButtonClick(i);
            basePage.nextTab();
        ...
        assertEquals(NUMBER_OF_REGISTER_NOW_BUTTON_BLOG_PAGE, goodTitlesCount);
    }

...
public class BasePage {
    ...
    private final By closePopupsButton = By.xpath("//button[@class='m2dNWvuZ9bW9']");
    private final By mainLogoButton = By.xpath("//a[@class='VgHUR10g']");
    private final By headerOpen = By.xpath("//button[@class='WjM9S js-modal-btn']");
    private final By footer = By.xpath("//div[@class='iLtEvWS']");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='hxMhQjX0Tch '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerOpenClick () {
        By checkHeader = By.xpath("(//a[@class='hxMhQjX0Tch '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='IqLyl2'])[" + numButton + "]");
        driver.findElement(footerButton).click();
        return this;
    }

    public BasePage scrollToFooter () {
